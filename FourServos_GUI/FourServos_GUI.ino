...
//int  limitS1      = 1;       // Input for the analog switch 
//int  limitS2      = 2;       // Input for the analog switch 
...
void setup() {
    ...
    //Serial.println("For example: '1130' will move servo #1 in 130 degrees\n");
}
